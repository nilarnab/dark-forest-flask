...
def new_membership(star_id: str, ship_ids: list[str], onboarded_at: float) -> UniverseMembership:
    return {"onboarded": True, "star_id": star_id, "ship_ids": {str(index): ship_id for index, ship_id in enumerate(ship_ids)}, "onboarded_at": onboarded_at}
